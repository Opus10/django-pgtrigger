...
#### Fixes
  ...
  - Properly support `psycopg.sql.SQL` and `psycopg.sql.Composed` objects in query execution when ignoring triggers by [@max-muoto](https://github.com/max-muoto) in [#186](https://github.com/Opus10/django-pgtrigger/pull/177).
